...
for character in classinfo['all']:
    print(f'{character["name"]}, a {character["skill level"]} {character["spirit animal"]} of a programmer, posseses a {character["super power"]} factor for moonlighting as a superhero!')
